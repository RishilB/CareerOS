  ...
  return (
    <Reveal className="flex h-full flex-col rounded-[28px] border border-border bg-surface/75 p-6 backdrop-blur">
      <div className="flex items-start justify-between gap-4">
        <div className="flex size-12 items-center justify-center rounded-2xl border border-border bg-white/7 p-2">
          <Image
        ...
        <Link
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex size-10 items-center justify-center rounded-full border border-border bg-white/5 text-muted hover:text-foreground"
